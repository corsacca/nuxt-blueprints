# Rate Limiting (Database) Block

Database-backed rate limiting for API endpoints. Queries the activity_logs table to count recent attempts. Persists across server restarts and works across multiple server instances.
